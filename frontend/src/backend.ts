...
import type { CourseRecommendation as _CourseRecommendation, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllCourseRecommendations(): Promise<Array<CourseRecommendation>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCourseRecommendations();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCourseRecommendations(arg0: string): Promise<CourseRecommendation | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCourseRecommendations(arg0);
    ...
    async getInterviewHistory(arg0: Principal): Promise<Array<InterviewSession>> {
        if (this.processError) {
            try {
                const result = await this.actor.getInterviewHistory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserStats(): Promise<Array<[Principal, bigint, bigint]>> {
        if (this.processError) {
            try {
    ...
    async saveCourseRecommendation(arg0: string, arg1: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveCourseRecommendation(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveInterview(arg0: string, arg1: Array<string>, arg2: Array<string>, arg3: bigint, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveInterview(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveResume(arg0: string, arg1: Array<string>, arg2: bigint, arg3: Array<string>, arg4: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveResume(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_CourseRecommendation]): CourseRecommendation | null {
    return value.length === 0 ? null : value[0];
}
